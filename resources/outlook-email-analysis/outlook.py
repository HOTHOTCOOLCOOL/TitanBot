...
IMPORTANT: 
- After calling find_emails, use the returned index to get attachments from the SAME search results
- Only returns document attachments (PDF, Word, Excel, PowerPoint, etc.) - ignores images
